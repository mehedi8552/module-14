...
import { FaTrello,FaGoogle,FaYandexInternational} from "react-icons/fa";
import { FiSlack } from "react-icons/fi";


const Card = () => {
    const companyLogos = [
        { name: <FaGoogle/>, url: "https://www.google.com/" },
        { name:  <FaTrello/>, url: "https://trello.com/" },
        { name: <FaYandexInternational/>, url: "https://www.notion.so/" },
        { name: <FiSlack/>, url: "https://slack.com/intl/en-gb/" },
      ];
